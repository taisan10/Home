...
//     <div className="absolute left-1/2 transform -translate-x-1/2 w-1 bg-blue-400/40 h-full"></div>
...
//         </div>
//         <div className="w-4 h-4 bg-blue-400 rounded-full shadow-lg mx-6 md:mx-8"></div>
...
//       style={{ width: "260px", top: "40%", left: "18%",  height: "200px"}}
...
//       alt="Team 2"
//       className="absolute rounded-xl shadow-xl"
//       style={{ width: "300px", top: "50%", right: "18%",  height: "200px" }}
//       whileHover={{ scale: 1.05 }}
//       whileInView={{ opacity: 1, y: 0 }}
//       initial={{ opacity: 0, y: 50 }}
...
//       alt="Office"
//       className="absolute rounded-xl shadow-xl"
//       style={{ width: "300px", top: "0%", right: "40%", height: "250px" }}
//       whileHover={{ scale: 1.05 }}
//       whileInView={{ opacity: 1, y: 0 }}
//       initial={{ opacity: 0, y: 50 }}
